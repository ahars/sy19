...
# Proba � post�riori d'appartenance aux classes
...
# Nous n'obtenons pas les m�mes r�sultats � chaque fois pour l'estimation
# des poids et des fronti�res de d�cision.
...
# Commentaires sur la variabilit� des mod�les en fonction de size.
