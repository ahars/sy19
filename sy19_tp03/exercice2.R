...
plot(x, col = couleur, main = "frontières de décision sur les observations (1)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (2)")
zp <- Z2[,4] - pmax(Z2[,3], Z2[,2], Z2[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z2[,1] - pmax(Z2[,2], Z2[,3], Z2[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (3)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (4)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (5)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (6)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (7)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (8)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (9)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (10)")
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 1)")
zp <- Z1[,4] - pmax(Z1[,3], Z1[,2], Z1[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z1[,1] - pmax(Z1[,2], Z1[,3], Z1[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 2)")
zp <- Z2[,4] - pmax(Z2[,3], Z2[,2], Z2[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z2[,1] - pmax(Z2[,2], Z2[,3], Z2[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 3)")
zp <- Z3[,4] - pmax(Z3[,3], Z3[,2], Z3[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z3[,1] - pmax(Z3[,2], Z3[,3], Z3[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 4)")
zp <- Z4[,4] - pmax(Z4[,3], Z4[,2], Z4[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z4[,1] - pmax(Z4[,2], Z4[,3], Z4[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 5)")
zp <- Z5[,4] - pmax(Z5[,3], Z5[,2], Z5[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z5[,1] - pmax(Z5[,2], Z5[,3], Z5[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 6)")
zp <- Z6[,4] - pmax(Z6[,3], Z6[,2], Z6[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z6[,1] - pmax(Z6[,2], Z6[,3], Z6[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 7)")
zp <- Z7[,4] - pmax(Z7[,3], Z7[,2], Z7[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z7[,1] - pmax(Z7[,2], Z7[,3], Z7[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 8)")
zp <- Z8[,4] - pmax(Z8[,3], Z8[,2], Z8[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z8[,1] - pmax(Z8[,2], Z8[,3], Z8[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 9)")
zp <- Z9[,4] - pmax(Z9[,3], Z9[,2], Z9[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z9[,1] - pmax(Z9[,2], Z9[,3], Z9[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(x, col = couleur, main = "frontières de décision sur les observations (size = 10)")
zp <- Z10[,4] - pmax(Z10[,3], Z10[,2], Z10[,1])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
zp <- Z10[,1] - pmax(Z10[,2], Z10[,3], Z10[,4])
contour(xp, yp, matrix(zp, len), add = TRUE, levels = 0, drawlabels = FALSE)
...
plot(probas, main = "Evolution des probabilité d'erreur en fonction de decay")
dev.off()
