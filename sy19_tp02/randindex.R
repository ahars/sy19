...
randindex <- function(P1, P2) {
	...
	cont1 <- matrix(rep(as.matrix(P1), nbIn), nrow = nbIn,byrow = T) == matrix(rep(as.matrix(P1), nbIn), nrow = nbIn, byrow = F)
	cont2 <- matrix(rep(as.matrix(P2), nbIn), nrow = nbIn,byrow = T) == matrix(rep(as.matrix(P2), nbIn), nrow = nbIn, byrow = F)
